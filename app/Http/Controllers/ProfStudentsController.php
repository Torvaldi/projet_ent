...
class ProfStudentsController extends Controller
{
    public function index() {
        ...
        return view('admin/student_list/admin_groups', compact('promotions'));
    }

    public function list_promotion(Promotion $promotion) {
        $semesters = Semester::with("users")->get();
        return view('admin/student_list/admin_promotion_users', compact('promotion', 'semesters'));
    }
    ...
    public function list_tp(Tpgroup $tpgroup) {
        $semesters = Semester::with("users")->get();
        return view('admin/student_list/admin_tp_users', compact('tpgroup', 'semesters'));
    }
}
